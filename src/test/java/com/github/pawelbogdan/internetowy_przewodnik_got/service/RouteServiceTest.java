...
class RouteServiceTest {
    ...
    @Test
    void addEdgesWithTimeWeight_NullGraph() {
        DirectedWeightedMultigraph graph = null;
        var exception = catchThrowable(() -> routeService.addEdgesWithTimeWeight(graph));

        assertThat(exception).isInstanceOf(IllegalArgumentException.class).hasMessage("Tried to insert edges to null graph.");
    }
